            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    if(user.isEmailVerified()){
                        ...
                        startActivity(new Intent(login.this, Splashscreen_loading.class));

                    }else{
                        user.sendEmailVerification();
                        Toast.makeText(login.this, "Accédez a votre email pour le vérifier ",Toast.LENGTH_LONG).show();


                    }

                }else{
                    Toast.makeText(login.this,"vérifiez vos cordonées",Toast.LENGTH_LONG).show();
                }
            }
        });
